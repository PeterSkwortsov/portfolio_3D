...
export const Overlay = () => {
  ...
  return (
    <>
      ...
      <div
        className={`absolute  m-auto z-10 w-full  right-0   bottom-0 flex flex-col justify-between  text-black ${
          visible ? "" : "opacity-0"
      ...
      >
        ...
        <div className="bg-gradient-to-t from-white pt-20 pb-5 p-4 flex items-center flex-col text-center">
          <h5 className="text-3xl font-extrabold text-purple-900">
