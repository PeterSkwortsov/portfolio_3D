    ...
    <div>
      <div>
        <div className="card text-black bg-amber-50">
          ...
          <button
            className="py-4 w-62 px-8 bg-gradient-to-r from-yellow-500 to-orange-600 hover:from-yellow-600 hover:to-orange-700 text-white font-extrabold rounded-2xl shadow-2xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center m-auto mb-6 mt-4 text-xl"
              ...
              <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
                <div className="p-6">
                  <p className="text-black mb-6">
                    Это пример того, как можно использовать технологии THREE.js в продажах своих продуктов.  
                  </p>
